...
public class allemployee extends JFrame implements ActionListener{
    ...
    public allemployee(){
       ...
       // department.setFont(new Font("Raleway",Font.BOLD,20));
        ...
        gender.setBounds(229, 10, 112, 30);
       ...
       // department.setFont(new Font("Raleway",Font.BOLD,20));
        ...
        salary.setBounds(453, 10,112, 30);
